...
👋 Hi, I’m @rogatec a backend and database engineer since 2011. In real life my name is pronounced `tea` 🍵 - `mohn` (the poppy flower in german)
...
- 📺 Besides binch watching series, I am also a huge fan of the NFL 🏈 (fly Eagles) and sometimes watching other sports NHL 🏒 (go Flyers), NBA 🏀 (go Mavs) or the german Bundesliga (VFB / FCB)
